...
|---|---|
| Deterministic contract compilation and compile-time rejection | Proven by [current merged compiler tests](https://github.com/Abhillashjadhav/production-engineering-os/blob/46667f3f30f32557a0a37428b37ec0dc04b2bdf1/tests/unit/test_acceptance_compiler.py) in [exact-head CI #32646333205](https://github.com/Abhillashjadhav/production-engineering-os/actions/runs/32646333205) |
| Meaningful-RED baseline, bounded repair, and six-state engine | Proven by the [current merged E1 fixture](https://github.com/Abhillashjadhav/production-engineering-os/blob/46667f3f30f32557a0a37428b37ec0dc04b2bdf1/tests/e2e/test_barebones_e1.py) and [planted eval suite](https://github.com/Abhillashjadhav/production-engineering-os/blob/46667f3f30f32557a0a37428b37ec0dc04b2bdf1/tests/e2e/test_barebones_evals.py) in [exact-head CI #32646333205](https://github.com/Abhillashjadhav/production-engineering-os/actions/runs/32646333205) |
| Hash-chained events and content-addressed evidence blobs | Proven by [current merged ledger tests](https://github.com/Abhillashjadhav/production-engineering-os/blob/46667f3f30f32557a0a37428b37ec0dc04b2bdf1/tests/unit/test_evidence_ledger.py) in [exact-head CI #32646333205](https://github.com/Abhillashjadhav/production-engineering-os/actions/runs/32646333205) |
| Candidate execution with real Bubblewrap, no network, a read-only host view, bounded resources, symlink containment, and fail-closed composition | Proven by the [current merged isolation tests](https://github.com/Abhillashjadhav/production-engineering-os/blob/46667f3f30f32557a0a37428b37ec0dc04b2bdf1/tests/unit/test_candidate_sandbox.py) in the dedicated Linux `candidate-isolation` matrix of [exact-head CI #32646333205](https://github.com/Abhillashjadhav/production-engineering-os/actions/runs/32646333205) |
| End-to-end scripted-provider `RELEASE_READY` engine path through real Bubblewrap | Proven by the [current merged E1 fixture](https://github.com/Abhillashjadhav/production-engineering-os/blob/46667f3f30f32557a0a37428b37ec0dc04b2bdf1/tests/e2e/test_barebones_e1.py), with the local sandbox fixture disabled under `PMPE_TEST_REAL_SANDBOX=true`, in [exact-head CI #32646333205](https://github.com/Abhillashjadhav/production-engineering-os/actions/runs/32646333205) |
