  ...
  trace_details: [
    {
      ...
      criteria: [
        ...
        { criterion_id: "C-CONF", name: "Groundedness", hard_gate: false, baseline_result: "pass", candidate_result: "fail", changed: false, state: "conflicting", verdict: "Conflicting definition between runs", rationale: "The hard-gate flag differs between the runs; the definitions conflict.", provenance: "both" },
