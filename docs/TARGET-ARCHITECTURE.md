...
| Pre-code | exact-SHA repository snapshot; separately versioned governance observation ID/digest/timestamp/query provenance; architecture, ADRs, threat model, TestPlan, issue/branch/draft-PR record, and meaningful-red evidence |
