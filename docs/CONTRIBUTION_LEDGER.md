...
| 4 | TBD | Engineering planning | Validated specs convert to an EngineeringPlan: task IDs, dependencies, topological order, component/data/API plan, complexity estimates | TRD planning requirements | planner unit tests passed | pending | pending | Plan is consumed by later stages; no execution yet |
